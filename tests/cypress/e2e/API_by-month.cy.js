describe('POST /api/predict/forecast/by-month', () => {
    context('SUCESSO', () => {
        it('Ao colocar um número de dias corretamente como inteiro e número suficiente de dias num mês:', () => {
            cy.request({
                method: 'POST',
                url: 'http://127.0.0.1:8000/api/predict/forecast/by-month',
    ...
    context('FALHA', () => {
        ...
        it.only('Ao colocar um número de dias menor que 0', () => {
            cy.request({
                method: 'POST',
                url: 'http://127.0.0.1:8000/api/predict/forecast/by-month',
